...
describe("Header", () => {
  describe("Header component", () => {
    ...
    it("Change burger menu visibility", () => {
      const headerInstance = setupHeaderComponent()
        .dive()
        .dive()
        .instance();
    ...
    it("Change burger menu visibility (for burger menu visible)", () => {
      ...
      const headerInstance = setupHeaderComponent(newParams)
        .dive()
        .dive()
        .instance();
      headerInstance.changeBurgerMenuVisibility();
  ...
  describe("Header navbar", () => {
    ...
    it("Change burger menu visibility", () => {
      ...
      const icon = setupHeaderNavbarComponent(newParams)
        .find(".burgerMenuIcon")
        .at(0);
      icon.simulate("click");
    });

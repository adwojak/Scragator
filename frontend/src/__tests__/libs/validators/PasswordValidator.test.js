...
describe('Password validator', () => {
    ...
    it('Value too short', () => {
        expect(PasswordValidator(tooShortValue)).toEqual(expect.arrayContaining([ TOO_SHORT, true ]));
    });

    it('Value too long', () => {
        expect(PasswordValidator(tooLongValue)).toEqual(expect.arrayContaining([ TOO_LONG, true ]));
    });

    it('Valid password', () => {
        expect(PasswordValidator(validPassword)).toEqual(expect.arrayContaining([ '', false ]));
    });
});